...
If you are low on time, you may jump to the description of the [docker-compose based setup](https://github.com/trustlines-network/relay/tree/develop/docker/trustlines).
