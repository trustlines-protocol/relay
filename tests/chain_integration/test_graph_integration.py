...
def test_trustline_update_with_interests(fresh_community, fresh_currency_network, accounts):
    A, B, *rest = accounts

    fresh_currency_network.update_trustline(A, B, 50, 100, 2, 3)
    fresh_currency_network.update_trustline(B, A, 100, 50, 3, 2)
